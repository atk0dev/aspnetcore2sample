...
namespace WebApplication1.Controllers.API
{
    ...
    public class PointsOfInterestController : Controller
    {
            ...
            [FromBody] PointOfInterestForCreationDto pointOfInterest)
        {
            ...
            var finalPointOfInterest = Mapper.Map<Models.PointOfInterest>(pointOfInterest);
            ...
            var createdPointOfInterestToReturn = Mapper.Map<Dto.PointOfInterestDto>(finalPointOfInterest);
